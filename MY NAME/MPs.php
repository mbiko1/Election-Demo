<?php 
    ...
    if(!$connection){
        ...
        if(isset($_POST['candidate-name']) && isset($_POST['id']) && $_SERVER['REQUEST_METHOD'] === 'POST'){
            ...
            $sql_update_value = "UPDATE candidate_votes SET member_of_p = '$inputValue' where national_id = '$id'";
            ...
            if(mysqli_query($connection, $sql_update_value)){
                header("Location: Councillors.php");
                exit();
            }else {
...
<body>
    ...
    <main>
        <div class="voting-guide">                       
            <h3>PART 2:</h3>
            <p>- Click on a Member of Parliament of your choice below. <br> 
                - Then click the <strong>Next</strong> button to confirm.</p>            
        </div>

        <h2>MEMBERS OF PARLIAMENT CANDIDATES</h2>

        <div class="out-candidate-grid">
            <div class="candidate-grid">
                <div onclick="divListener(1)" class="candidate-card">
                    <img src="img/chipo.jpg" alt="Candidate Picture" class="candidate-picture">
                    <div class="candidate-info">
                        <div class="candidate-name">Miss Chiposa Chiomba</div>
                ...
                <div onclick="divListener(2)" class="candidate-card">
                    <img src="img/major.jpg" alt="Candidate Picture" class="candidate-picture" width="200px"
                        height="250px">
                    <div class="candidate-info">
                        <div class="candidate-name">Mr. Major Nthala</div>
                        <div class="party-name">The Famous Ireen (TFI)</div>
                    </div>
                    <div class="radio-circle"><img src="social_15707749.png" alt=""></div>
                </div>
                <div onclick="divListener(3)" class="candidate-card">
                    <img src="img/thumbiko.jpg" alt="Candidate Picture" class="candidate-picture">
                    <div class="candidate-info">
                        <div class="candidate-name">Mr. Thumbiko Banda</div>
    ...
    <form action="MPs.php" method="post" id="form">
    ...
    <script>
        ...
        document.getElementById('prev').addEventListener('click', function () {
            window.location.href = "Presidents.html";
        });
        ...
        function divListener(divID){            
            if(divID == 1){             
                setCandidateName = "Mp1";
                setId = "1";
            }
            if(divID == 2){
                setCandidateName = "Mp2";
                setId = "2";               
            }
            if(divID == 3){
                setCandidateName = "Mp3";
                setId = "3";                
            }
